        ...
        {sent ? (
          ...
          <form onSubmit={signIn} className="space-y-3">
            <input
              ...
              value={email}
              onChange={(e) => {
                console.debug("[LoginPage] email change", e.target.value);
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full rounded-xl bg-primary px-3 py-2 text-white text-sm font-medium disabled:opacity-50"
            >
